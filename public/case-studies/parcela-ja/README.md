...
- `search-random.png`           — Search with random/partial input
- `store-page-nike.png`         — Nike brand page

## Shop Nearby & Online
- `all-stores-nearby.png`  — All Stores Nearby expanded list
- `shop-online.png`        — Shop Online tab
...
## Tips
- Recommended export: 390×844px (iPhone 14 logical) or 2x/3x
- Format: PNG with transparency trimmed, or JPG at 85% quality
- The PhoneFrame component handles aspect-ratio and object-fit automatically
